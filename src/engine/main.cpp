...
void setupscreen()
{
    ...
    screen = SDL_CreateWindow(game::gameident(), winx, winy, winw, winh, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_INPUT_FOCUS | SDL_WINDOW_MOUSE_FOCUS | flags);
...
int main(int argc, char **argv)
{
    ...
    if(dedicated <= 1)
    {
        ...
        if (SDL_VERSIONNUM(version.major, version.minor, version.patch) <= SDL_VERSIONNUM(2, 0, 12))sdl_xgrab_bug = 1;
#endif
    }
    logoutf("init: net");
