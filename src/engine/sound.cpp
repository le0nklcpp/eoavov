...
ICOMMAND(gamesoundpos, "sfffi",(char*name,float*x,float*y,float*z,int*vol),{const vec v = vec(*x,*y,*z);game::sound(name,&v,*vol);});
ICOMMAND(gamesound,"s",(const char*name),game::sound(name));
void resetsound()
{
