...
namespace game
{
    ...
    extern void edittoggled(bool on,bool post=true);
    ...
    extern void physicstrigger(physent *d, bool local, int floorlevel, int waterlevel, int material = 0,int timeinair = 0);
