...
extern bool mmintersect(int index, const vec&pos, int yaw, int pitch, int roll, const vec&o, const vec&ray, float maxdist, int mode, float &dist, float scale=1.0);
