...
void printent(extentity &e, char *buf, int len)
{
    ...
    nformatstring(buf, len, "%s %d %d %d %d %d %.2f %.2f %.2f", entities::entname(e.type), e.attr1, e.attr2, e.attr3, e.attr4, e.attr5, e.o.x,e.o.y,e.o.z);
}
...
ICOMMAND(printentinfo, "",  (), entfocus(efocus, string s;printent(e,s,sizeof(s)); conoutf("%s",s);));
