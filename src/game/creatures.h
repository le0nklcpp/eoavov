...
creatureEntity(entity &e):crtype(e.attr2),controlled(false),vangles(0,0,0),muzzle(0,0,0),team(0),warned(false),lastattacktime(-1),lastdamagetime(0),lastsuccessattacktime(0),nextattacktime(0){o = e.o;roll = e.attr1;type = E_CREATURE;}
~creatureEntity(){}
};
#endif
